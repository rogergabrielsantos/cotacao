    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="Jumbotron text-center">
                ...
                ?>
                <br>
                <img  src="../imagens/moto2.png" usemap= "#meumapa">
                <map name="meumapa">
                    <area shape="rect" onclick="dano('MB1')" coords="3,3,71,108" href= "frameDano.php?dano=MB1" target= "janela" />
                    <area shape="rect" onclick="dano('MB2')" coords="72,3,140,108" href= "frameDano.php?dano=MB2" target= "janela" />
                    <area shape="rect"  onclick="dano('MB3')" coords="140,3,208,108" href= "frameDano.php?dano=MB3" target= "janela" />
                    <area shape="rect"  onclick="dano('MB4')" coords="209,3,277,108" href= "frameDano.php?dano=MB4" target= "janela" />
                    <area shape="rect"   onclick="dano('MB5')"coords="277,3,344,108" href= "frameDano.php?dano=MB5" target= "janela" />

                    <area shape="rect" onclick="dano('MB6')" coords="3,110,71,212" href= "frameDano.php?dano=MB6" target= "janela" />
                    <area shape="rect" onclick="dano('MB7')" coords="71,110,140,212" href= "frameDano.php?dano=MB7" target= "janela" />
                    <area shape="rect"  onclick="dano('MB8')" coords="140,110,208,212" href= "frameDano.php?dano=MB8" target= "janela" />
                    <area shape="rect"   onclick="dano('MB9')"coords="208,110,277,212" href= "frameDano.php?dano=MB9" target= "janela" />
                    <area shape="rect"  onclick="dano('MB10')"  coords="277,110,343,212" href= "frameDano.php?dano=MB10" target= "janela" />
