...
class cotacao {
    ...
    function reprova($cod, $l) {
        $sql = mysqli_query($l, "update cotacao set situacao ='reprovada'  where cod ='$cod'") or die(mysqli_error_());
        //echo("<script type='text/javascript'> alert('Dados Alterados com sucesso !!!'); location.href='menu1.php';</script>");
    }
     function restaura($cod, $l) {
        $sql = mysqli_query($l, "update cotacao set situacao ='Aberto'  where cod ='$cod'") or die(mysqli_error_());
        //echo("<script type='text/javascript'> alert('Dados Alterados com sucesso !!!'); location.href='menu1.php';</script>");
    }
    ...
    function mostra3($nome, $l, $codvendedor) {
        $sql = mysqli_query($l, "select * from cotacao where nome LIKE '%" . $nome . "%' and codvendedor='$codvendedor' and situacao <>'Aprovada' and situacao <>'reprovada'") or die(mysqli_error_());
        while ($row = mysqli_fetch_array($sql)) {
    ...
    function mostra4($l) {
        $sql = mysqli_query($l, "select * from cotacao where situacao = 'Aprovada' and situacao <>'reprovada'") or die(mysqli_error_());
        while ($row = mysqli_fetch_array($sql)) {
    ...
    function mostra6($l) {
        $sql = mysqli_query($l, "select * from cotacao where situacao = 'reprovada'") or die(mysqli_error_());
        while ($row = mysqli_fetch_array($sql)) {
    ...
    function mostra7($l, $codvendedor) {
        $sql = mysqli_query($l, "select * from cotacao where codvendedor='$codvendedor' and situacao = 'reprovada'") or die(mysqli_error_());
        while ($row = mysqli_fetch_array($sql)) {
