...
if (isset($_POST['nome'])) {
    ...
    if ($_SESSION['perfil'] == "2") {
        $A->mostra7($nome, $link, $_SESSION['codvendedor']);
    } else {
        $A->mostra3($nome, $link);
    }
...
<div class="container">
    ...
    ?>
    <h3 class="text-center text-dark pt-2">Fazer Filiação</h3>
    <form action="buscaFiliar.php" method="Post">
    ...
    <form action="filiar.php" method="Post">
        ...
        if ($controle > 0) {
            for ($i = 0; $i < count($A->getCodigo()); $i++) {
                ...
                echo ' 
                                ...
                                <input  onclick="codigo(' . $A->getCodigo()[$i] . ')" type="image" src="imagens/associar.png" value="Consulta">
